...
/**
 * FACADE - class implements business logic AdminFACADE class will contain not
 * just the action needed to perform(DAO and DAODB) but also the testing needed
 * to validate the action matches the business logic. </b>Example: createCompany
 * method would contain first a check that there is no Company with this name in
 * the DB only then would create new Company.</b>
 * 
...
public class AdminFacade implements CouponClientFacade {
	...
	/**
	 * AdminFacade Constructor initialing the CompanyDaoDB, CustomerDaoDB
	 * ,CouponDaoDB classes , to use it later on in the Facade logic.
	 * @param customerDao 
	 * @param companyDao 
	 */
	public AdminFacade(CompanyDaoDB companyDao, CustomerDaoDB customerDao) {
		super();
	...
	/**
	 * checkClientType method will check what is the Client type , and return
	 * the CouponClientFacade string, example the return value of AdminFacade
	 * object is AdminFacade.
	 * 
	 * @param obj
	 *            This is a CouponClientFacade object.
	 * @return String example the return value of AdminFacade object is
	 *         AdminFacade
	 */
	...
	/**
	 * createCompany method first check if a Company doesn't exist by name, and
	 * then create a new Company according to the Java Bean created object.
	 * 
	 * @param company
	 *            The Java Bean Company object
	...
	public void createCompany(Company company) throws CouponSystemException {
		try {
			...
			throw new FacadeException("Create Company failed " + e.getMessage());
		}

	}

	/**
	 * removeCompany first check if a Company exist by Id in the DB, and if
	 * exist remove the map Company reference from the company_coupon table ,
	 * and then remove the Company.
	 * 
	 * @param company
	 *            The Company object in the DB
	 * @throws CouponSystemException
	 */
	...
	/**
	 * updateCompany method first check if a Company doesn't exist by name, and
	 * then update Company in the DB according to the sent Company parameter.
	 * 
	 * @param company
	 *            The Java Bean Company object
	 * @throws CouponSystemException
	...
	/**
	 * getCompany method first check if a Company exist by Id in the DB, and
	 * then pull it from the DB.
	 * 
	 * @param company_id
	 *            The company Id of the Java Bean Company object
	...
	/**
	 * getAllCompanies method pull all the Companies from the DB , if no company
	 * exist in DB return null.
	 * 
	...
	public Collection<Company> getAllCompanies() throws CouponSystemException {
		try {
			...
			throw new FacadeException("get All Companies failed " + e.getMessage());
		}
	}

	/**
	 * createCustomer method first check if a Customer doesn't exist by name,
	 * and then create a new Customer according to the Java Bean created object.
	 * 
	 * @param customer
	 *            The Java Bean Customer object
	 * @throws CouponSystemException
	 */
	public void createCustomer(Customer customer) throws CouponSystemException {
		...
		try {
			...
			throw new FacadeException("Create Customer failed " + e.getMessage());
		}
	...
	/**
	 * removeCustomer first check if a Customer exist by Id in the DB, and if
	 * exist remove the map Customer reference from the customer_coupon table ,
	...
	public void removeCustomer(Customer customer) throws CouponSystemException {
		...
		try {
			...
			throw new FacadeException("remove customer failed " + e.getMessage());
		}
	}

	/**
	 * updateCustomer method first check if a Customer doesn't exist by name,
	 * and then update Customer in the DB according to the sent Customer
	 * parameter.
	 * 
	 * @param customer
	 *            The Java Bean Customer object
	...
	public void updateCustomer(Customer customer) throws CouponSystemException {
		...
		try {
			...
			throw new FacadeException("Update customer failed " + e.getMessage());
		}
	}

	/**
	 * getCustomer method first check if a Company exist by Id in the DB, and
	 * then pull it from the DB.
	 * 
	 * @param customer_id
	 *            The Customer Id of the Java Bean Customer object
	...
	public Customer getCustomer(long customer_id) throws CouponSystemException {
		try {
			...
			throw new FacadeException("get customer failed " + e.getMessage());
		}

	}

	/**
	 * getAllCustomers method pull all the Customers from the DB , if no
	 * Customer exist in DB return null.
	 * 
	...
	public Collection<Customer> getAllCustomers() throws CouponSystemException {
		...
		try {
			...
			throw new FacadeException("get All Customers failed " + e.getMessage());
		}
